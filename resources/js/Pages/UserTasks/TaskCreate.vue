            ...
            <div class="m-7">
               <form @submit.prevent="submit">
                    ...
                    <div class="p-2 flex justify-end rounded-b">
                      <button type="submit" class="w-full px-3 py-4 text-black bg-white-100 rounded-md focus:bg-indigo-300 border-2 focus:outline-none"> <a href="/User"> Annuler</a></button>
...
export default {
 ...
 props:['errors'],
  methods: {
    submit() {
      this.$inertia.post(this.route('user.task.store'), this.form);
    },
  },
