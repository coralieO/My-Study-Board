            ...
            <div class="m-7">
               <form @submit.prevent="submit">
                    ...
                    <div class="p-2 flex justify-end rounded-b">
                      <button type="submit" class="w-full px-3 py-4 text-black bg-white-100 rounded-md focus:bg-indigo-300 border-2 focus:outline-none"> <a href="/user/dashboard"> Annuler</a></button>
...
export default {
 data() {
    return {
      form: this.$inertia.form({
        ...
        create_at:this.tasks.create_at,
      })
    }
  },
 components: {
 ...
 props:['errors', 'tasks'],
  methods: {
    submit() {
       this.$inertia.put(this.route('admin.task.update', this.tasks.id), this.form)
